    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow group">
            ...
            <div className="relative h-48 w-full bg-[#FAFAFA] flex items-center justify-center p-4">
                {/* Wishlist Button */}
                <button className="absolute top-3 right-3 p-1.5 rounded-full bg-white/50 hover:bg-white text-gray-400 hover:text-red-500 transition-colors">
            ...
            <div className="p-4">
                ...
                <button className="w-full py-2.5 bg-[#146041] hover:bg-[#0e4b32] text-white rounded-xl font-semibold transition-colors flex items-center justify-center gap-2">
                    + Add to Cart
                </button>
            </div>
        </div>
