...
export default function AuthLayout({
  ...
  const imageSrc = isAdminRoute ? "/admin.jpg" : "/login.jpg";
    ...
    <div className="grid min-h-svh lg:grid-cols-2">
          ...
          {isAdminRoute ? (
            <>
              ...
              <h2 className="text-4xl font-bold leading-tight md:text-5xl">
                Manage users, orders, and credit in one place.
              </h2>
              <p className="max-w-md text-sm font-medium text-white/90 md:text-lg">
                Secure dashboard to approve businesses, track orders, and control
      ...
      <div className="flex flex-col gap-4 p-6 md:p-10">
        <div className="flex justify-center">
          <span className="font-brand text-3xl font-bold text-primary md:text-4xl">
            Unified Products
          </span>
        </div>
