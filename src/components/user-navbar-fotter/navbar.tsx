              ...
              <div className="flex items-center gap-3">
                {PROMO_CODES.map((promo) => (
                  <button
                    ...
                    className={`group relative flex items-center gap-2 px-3 py-1.5 rounded-xl border-2 border-dashed transition-all duration-300 ${copiedCode === promo.code
                      ? "bg-white border-white text-primary scale-105"
                      : "border-white/20 text-white hover:border-white/50 hover:bg-white/10"
                      }`}
                  >
                    <Ticket className={`w-3.5 h-3.5 ${copiedCode === promo.code ? "text-primary" : "text-white/60 group-hover:text-white"}`} />
                    <div className="flex flex-col items-start leading-none">
                      <span className="text-[9px] font-black uppercase opacity-70">{promo.discount}</span>
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="left" className="w-75 sm:w-95 p-6">
              <div className="flex justify-between items-center mb-8">
                <Link href="/" onClick={() => setIsOpen(false)} className="font-brand">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                          <span className="text-xs font-bold text-primary">{promo.discount}</span>
                          <span className="text-lg font-black text-[#1A2D42]">{promo.code}</span>
                        </div>
                      </div>
